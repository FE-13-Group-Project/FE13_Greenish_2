...
export function regisEvent(datax,id) { 
    return(async()=>{
        const data = await axios.get(`https://634c991cf5d2cc648e90dc64.mockapi.io/gre/1/event/${id}`)
        console.log(data.data.personRegis)
        axios.put(`https://634c991cf5d2cc648e90dc64.mockapi.io/gre/1/event/${id}`,{personRegis : data.data.personRegis+1})
        axios.post("https://634c991cf5d2cc648e90dc64.mockapi.io/gre/1/paticipant",datax)
    })
