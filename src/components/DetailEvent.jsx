  ...
  return (
    <div style={{ maxWidth: "100%", backgroundColor: "beige" }}>
        ...
        if (item.id == id) {
          ...
          return (
            <div key={item.id}>
              ...
              <ProgressBar style={{maxWidth:'700px',margin:'auto',backgroundColor:'#b3b3b3',height:'25px'}} variant="success" now={item.personRegis} max={item.maxPerson} />
              <div className="person" style={{padding:'5px 10px',maxWidth:'700px',margin:'auto',display:'flex',justifyContent:'space-between'}}>
                <div className="person">
                <p style={{fontSize:'18px',fontWeight:'500'}}>{item.personRegis} / {item.maxPerson} pendaftar saat ini</p> 
                </div>
                <div className="date">
                  <p style={{fontSize:'18px',fontWeight:'500'}}>hingga {item.dateEvent}</p>
                </div>
              </div>
              <Container style={{marginTop:'20px',padding:'15px',width:'100%'}}>
                <Row  >
                  <Col lg={4}><h4>Organizer</h4></Col>
                </Row>
                <Row style={{marginTop:'20px'}}>
                <Col lg={"auto"}><img src="https://www.w3schools.com/howto/img_avatar.png" alt="" style={{width:"50px",height:'50px',borderRadius:'50%'}}/></Col>
                <Col lg={"auto"}>
                  <h5>{item.CP}</h5>
                  <p>{item.noTelp}</p>
                </Col>
              ...
              <h2 style={{margin:'auto',textAlign:'center'}}>Ayo daftarkan dirimu sekarang</h2>
              ...
              <div
                ...
                >
                  <div className="text" style={{display:'hidden',height:'fit-content',width:'fit-content',position:'absolute',color:'white',left:'0',right:'0',top:"0",bottom:"0",margin: "auto"}}><h2>MAAF BELUM LOGIN</h2></div>
                </div>
      <Row className="mb-3">
      ...
      <Form.Group className="mb-3" controlId="formGridAddress2">
        ...
        <Form.Control type="email" placeholder="Youremai@gmail.com" />
      </Form.Group>
      
      <Form.Group className="mb-3" controlId="formGridAddress2">
        <Form.Label>phone</Form.Label>
        <Form.Control type="number" placeholder="085..." />
      </Form.Group>
