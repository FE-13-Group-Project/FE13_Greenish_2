      ...
      <div className="aboutus-background">
         ...
         <div className="aboutus-background">
            <div className="container-fluid banner">
               ...
               <div className="container-fluid boxtext-aboutus"></div>
            </div>
         </div>
         <div className="container container-about-us">
               ...
               <div className="group-card group-card-aboutus">
                  ...
                  <div className="card" style={{ width: "18rem" }}>
                     ...
                     <div className="card-body">
                        ...
                        <p className="card-text">
                           Kami mengutamakan komunikasi antar penggiat
                           lingkungan, aktivis, orang umum, serta kami sebagai
                           perantara yang menjamin kualitas komunikasinya.
                        </p>
                     </div>
                  </div>
               </div>
            ...
            <div className="content-aboutus">
               ...
               <div className="picture-aboutus">
                  <img
                     src="https://images.unsplash.com/photo-1598335624134-5bceb5de202d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8cGxhbnRpbmd8ZW58MHx8MHx8&auto=format&fit=crop&w=600&q=60"
                     alt=""
                  />
                  <img
                     src="https://images.unsplash.com/photo-1588106832140-87523dd73ed0?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80"
                     alt=""
                  />
                  <img
                     src="https://images.unsplash.com/photo-1588196749597-9ff075ee6b5b?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1074&q=80"
                     alt=""
                  />
                  <img
                     src="https://images.unsplash.com/photo-1559223607-a43c990c692c?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80"
                     alt=""
                  />
                  <img
                     src="https://images.unsplash.com/photo-1622383563227-04401ab4e5ea?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8M3x8cGxhbnRpbmd8ZW58MHx8MHx8&auto=format&fit=crop&w=600&q=60"
                     alt=""
                  />
                  <img
                     src="https://images.unsplash.com/photo-1618477461062-00c999edbfca?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwcm9maWxlLXBhZ2V8MTB8fHxlbnwwfHx8fA%3D%3D&auto=format&fit=crop&w=600&q=60"
                     alt=""
                  />
               </div>
            </div>
